...
| 9C — App state machine | pending commit | [phase_9C_app_state_rtt_2026-05-08.txt](phase_9C_app_state_rtt_2026-05-08.txt) | 2026-05-08 | Phase 6O harness (75 s); manual button presses + UART `a`/`s`/`r` on COM5; first multi-source workload composition | PASS — Phase 9C app state init banner present; ROBOTOS_APP final state=ACTIVE transitions=23 button=20 uart=3 ignored=0; 23 per-transition diagnostic lines (20 src=BTN, 3 src=UART) explain full causality chain; OBS accepted=98 dispatched=97 pending=1 peak=4 dropped=0; CFSR=0 HFSR=0 (16 occurrences); 30954 bytes |
